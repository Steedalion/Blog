...
The third issue of ethical use of data is of growing concern. In general, there have been numerous scandals involving mega-corporations like Google, Facebook, and Amazon regarding the abuse of general users' data [[Cambridge analytica](https://doi.org/10.1016/j.ijhcs.2020.102498)]. While Europe has regulated the storage location and uses of citizen data [[GDPR](https://gdpr-info.eu/)], they have also begun looking at the ethical use of data in the workforce [[1](https://doi.org/10.1111/1468-2230.12357)], quoting the right to privacy [[Article 8](https://www.echr.coe.int/documents/d/echr/Guide_Art_8_ENG)]. Regulations inhibit the sharing of data between business entities and limit the application of data for hiring based on performance.
